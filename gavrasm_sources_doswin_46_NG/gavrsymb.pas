...
{ Version 1.1, Last changed: 07.07.2019 }
Unit gavrsymb;
...
Function AddSymbol(c:Char;s:String;fVal:Boolean;i:Int64):Boolean;

{ sets the value of the symbol s with the type c to the value i,
  returns false, if undefined }
Function SetSymbol(sc:String;s:String;fValid:Boolean;i:Int64):Boolean;
...
Function GetSymbolValue(sTypes:String;s:String;Var fValid:Boolean;Var iValue:Int64):Boolean;
