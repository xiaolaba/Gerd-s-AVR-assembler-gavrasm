...
{
  ***********************************************************
  * Gerd's AVR-Assembler Version 3.6 as of January 04, 2017 *
  * Free Pascal, source code, (C)2015 by DG4FAC             *
  * New in Version 3.6: See ReadMe.Txt for version info     *
  ***********************************************************
}
Program gavrasm;
...
Const
  ...
  asHeader:Array[1..nHeader] Of String=(
    ...
    '+------------------------------------------------------------+');
  lHeader:String='gavrasm Gerd''s AVR assembler version 3.6 (C)2017 by DG4FAC';
  cTab=Char(9);
...
Var sfn:String; { filename of the source file }
    ...
    fInternalOff,fEepromErr:Boolean; { Command line options }
...
With aDevices[nDev] Do
  ...
  If (pe>ne) And (Not fEepromErr) Then Error(82,IntToStr(pe),IntToStr(ne));
